...
```{r makelinks}
Links<- character()
  Links[1]<-  "LoanStats3a_securev1.csv" 
  Links[2]<-  "LoanStats3b_securev1.csv"
  Links[3]<-  "LoanStats3c_securev1.csv"
  Links[4]<-  "LoanStats3d_securev1.csv"
  Links[5]<-  "LoanStats_securev1_2016Q1.csv"
  Links[6]<-  "LoanStats_securev1_2016Q2.csv"
  Links[7]<-  "LoanStats_securev1_2016Q3.csv"
  Links[8]<-  "LoanStats_securev1_2016Q4.csv"
  Links[9]<-  "LoanStats_securev1_2017Q1.csv"
  Links[10]<- "LoanStats_securev1_2017Q2.csv"
  Links[11]<- "LoanStats_securev1_2017Q3.csv"
  Links[12]<- "LoanStats_securev1_2017Q4.csv"
  Links[13]<- "LoanStats_securev1_2018Q1.csv"
  Links[14]<- "LoanStats_securev1_2018Q2.csv"
  Links[15]<- "LoanStats_securev1_2018Q3.csv"
```
...
rm(list=paste0("LendingClubData_",2007:2018))
