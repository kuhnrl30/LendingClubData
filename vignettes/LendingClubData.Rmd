...
The dataset is too big to be hosted on Github as a single file, even compressed as an .rda file. To get around this limitation, I have split the dataset into two data frames and then created the \code{IssuedLoans()} function which combines them again.
